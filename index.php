...
if($status==0)
{
$msg="Your account is Inactive. Please check with admin";
} else{
        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    ...
                    <li class="no-padding"><a class="waves-effect waves-grey" href="forgot-password.php"><i class="material-icons">account_box</i>Employee Pass Recovery</a></li>

                    <li class="no-padding"><a class="waves-effect waves-grey" href="admin/"><i class="material-icons">account_box</i>Admin Login</a></li>
                    <li class="no-padding"><a class="waves-effect waves-grey" href="director/"><i class="material-icons">account_box</i>Director Login</a></li>

                </ul>
          <div class="footer">
                    <p class="copyright"><a>Francis maina </a>©</p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4 style="text-align:center">Employee login</h4></div>
